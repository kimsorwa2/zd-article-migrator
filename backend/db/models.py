...
class Instance(Base):
    ...
    oauth_client_id: Mapped[str] = mapped_column(String(255), nullable=False, default="", server_default="")
    oauth_client_secret: Mapped[str] = mapped_column(Text, nullable=False, default="", server_default="")
    oauth_redirect_uri: Mapped[str] = mapped_column(String(500), nullable=False, default="", server_default="")
    oauth_scopes: Mapped[str] = mapped_column(String(255), nullable=False, default="", server_default="")
    oauth_access_token: Mapped[str] = mapped_column(Text, nullable=False, default="")
    oauth_refresh_token: Mapped[str] = mapped_column(Text, nullable=False, default="")
    oauth_token_expires_at: Mapped[str] = mapped_column(String(32), nullable=False, default="", server_default="")
